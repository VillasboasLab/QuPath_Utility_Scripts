...
//masksDir=/Q:\SEG_MASKs\IH_37/
//def outputPath = "Q:/Quantifications/IH_37_Quant.tsv"
masksDir=/Y:\Ilastik_Masks\Melanoma\Mel21_4/
...
directoryOfMasks.eachFileRecurse (FileType.FILES) { file ->
if (file.getName().endsWith("_mask.tiff"))
    { wholecellfiles << file }
}
