...
def nCrops = 8
def outDir = "Q:/PixelClassifierTrainingCrops"
//def outDir = "X:/SHARED/CODEX/Raymond/LungTMA_Crops"
//def outDir = "X:/SHARED/CODEX/Raymond/BrestCancer_TNBCPilot_Crops"
...
if( proceed ){
    ...
    for (i = 0; i < nCrops; i++) {
        ...
        annotation.setName("CropAdd_${i+1}")
...
if( proceed2 ){
    ...
    {
        def annotCrops = getAnnotationObjects()
        annotCrops.each{
            //println(it.getName())
            it.setLocked(true)
